                        ...
                        <nav id="mainnav" class="mainnav">
                            <ul class="menu">
                                <li>
                                    <a href="index">HOME</a>
                                    <ul class="submenu">
                                        <li><a href="index">Homepage Style 1</a></li>
                                        <li><a href="index-v2">Homepage Style 2</a></li>
                                        <li><a href="index-v3">Homepage Style 3</a></li>
                                        <li><a href="index-v4">Homepage Style 4</a></li>
                                        <li><a href="index-v5">Homepage Style 5</a></li>
                                        <li><a href="index-v6">Homepage Style 6</a></li>
                                        <li><a href="index-v7">Homepage Style 7</a></li>
                                        <li><a href="index-v8">Homepage Style 8</a></li>
                                        <li><a href="index-v9">Homepage Style 9</a></li>
                                        <li><a href="index-v10">Homepage Style 10</a></li>    
                                    </ul>
                                </li>
                                <li class="active">
                                    <a href="shop-3col">SHOP</a>
                                    <ul class="submenu">
                                        <li>
                                            <a href="shop-3col">Shop Layouts</a>
                                            <ul class="submenu">
                                                <li><a href="shop-3col">Three Columns</a></li>
                                                <li><a href="shop-4col">Four Columns</a></li>
                                                <li><a href="shop-5col">Five Columns</a></li>
                                                <li><a href="shop-3col-slide">Slidebar Three Columns</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="shop-detail-des">Shop Details</a>
                                            <ul class="submenu">
                                                <li><a href="shop-detail-des">Details Description</a></li>
                                                <li><a href="shop-detail-exter">Details External</a></li>
                                                <li><a href="shop-detail-option">Details Options</a></li>
                                                <li><a href="shop-detail-fix">Details Fix</a></li>
                                                <li><a href="shop-detail-zoom">Details Zoom</a></li>
                                                <li class="active"><a href="shop-detail-group">Details Grouped</a></li>
                                                <li><a href="shop-detail-video">Details Video</a></li>                                                
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul class="submenu">
                                        <li><a href="blog-list">Blog List Full</a></li>
                                        <li><a href="blog-list-1">Blog list Slide 1</a></li>
                                        <li><a href="blog-list-2">Blog list Slide 2</a></li>
                                        <li><a href="blog-grid">Blog Gird Full</a></li>
                                        <li><a href="blog-grid-1">Blog Gird Slide</a></li>
                                ...
                                <li >
                                    ...
                                    <ul class="submenu right-submenu">
                                        ...
                                        <li><a href="contact-v2">Contact Style 2</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </nav><!-- /.mainnav -->
    			...
    			<div class="row">
    				<div class="col-md-12">
    					<div class="page-title-heading">
    						<h1 class="title">Shoes Men</h1>
    					</div><!-- /.page-title-heading -->
    					<div class="breadcrumbs">
    						<ul>
    							<li><a href="index">Home</a></li>
    							<li><a href="shop-3col">Shop</a></li>
                                <li><a href="shop-detail-group">Products</a></li>
    						</ul>
    					</div><!-- /.breadcrumbs -->
    				</div><!-- /.col-md-12 -->
    			</div><!-- /.row -->
                    	...
                    	<div class="wrap-flexslider">
                            <div class="inner padding-top-5">
                                <div class="flexslider style-2 has-relative">
                                    <ul class="slides">
                                        <li data-thumb="images/shop/sh-detail/thumb-detail-12.jpg">
                        ...
                        <div class="product-detail">
                            <div class="inner">
                                <div class="content-detail">
                                    <h2 class="product-title">Lace-up suede sneakers</h2>
                                    ...
                                    <div class="price">
                                        <ins class="no-padding"><span class="amount">$24.00 - $80.00</span></ins>
                                    </div>
                                    <div class="quantity-group">
                                        <div class="quantity-group-item  clearfix">
                                            ...
                                            <div class="name two"><h6><a href="#">Lace suede sneakers</a></h6></div>
                                        ...
                                        <div class="quantity-group-item clearfix">
                                            ...
                                            <div class="name two"><h6><a href="#">Hoodie cotton sweatshirt</a></h6></div>
                                            <div class="price three">
                                                <ins ><span class="amount">$24.00</span></ins>
                                                <del><span class="regular">$38.00</span></del>
                                            </div>
                                        </div>
                                        <div class="quantity-group-item clearfix">
                                            <div class="quantity one">
                                                <input type="text" value="0" name="quantity-number" class="quantity-number">
                                                <span class="inc quantity-button">+</span>
                                                <span class="dec quantity-button">-</span>
                                            </div>
                                            <div class="name two"><h6><a href="#">Slim-fit Grey Jan jeans</a></h6></div>
                                            <div class="price three">
                                                <ins class="text-accent"><span class="amount">Out Of Stock</span></ins>
                                            </div>
                                        </div>
                                    </div>                                    
                                    ...
                                    <div class="product-categories margin-top-32">
					...
					<div class="col-md-3">
						<div class="widget widget-brand">
							<div class="logo logo-footer">
								<a href="index"><img src="images/logo@2x.png" alt="image" width="107" height="24"></a>
							</div>
