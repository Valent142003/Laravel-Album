                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li>
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li class="active"><a href="shop-detail-fix">Details Fix</a></li>
    				...
    				<div class="col-md-12">
    					...
    					<div class="breadcrumbs">
    						<ul>
                                ...
                                <li><a href="shop-detail-fix">Products</a></li>
    						</ul>
    					</div><!-- /.breadcrumbs -->
    				</div><!-- /.col-md-12 -->
    			</div><!-- /.row -->
                    	...
                    	<div class="flat-image-box clearfix">
                            <div class="inner padding-top-4">
                                <ul class="product-list-fix-image">
                                    ...
                                    <li>
                                        <img src="images/shop/sh-detail/detail-05.jpg" alt="Image">
                                    </li>
                                    <li>
                                        <img src="images/shop/sh-detail/detail-06.jpg" alt="Image">
                                    </li>
                                </ul>
                            </div>   
                        </div>		                        
