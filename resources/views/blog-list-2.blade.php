                            ...
                            <ul class="menu">
                                ...
                                <li class="active" >
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li class="active"><a href="blog-list-2">Blog list Slide 2</a></li>
    				...
    				<div class="col-md-12">
    					...
    					<div class="breadcrumbs">
    						<ul>
    							...
    							<li><a href="blog-list-2">Blog</a></li>
    						</ul>
    					</div><!-- /.breadcrumbs -->
    				</div><!-- /.col-md-12 -->
    			</div><!-- /.row -->
    					...
    					<div class="post-wrap style2">
    						...
    						<article class="post clearfix">
    							...
    							<div class="content-post">
    								...
    								<div class="entry-post">
    									<p>There’s nothing more personal in anyone’s wardrobe than their jewellery. It tells a story beyond the possibili-ties of most clothes...</p>
    									<div class="more-link">
                            ...
                            <article class="post clearfix">
                                ...
                                <div class="content-post">
                                    ...
                                    <div class="entry-post">
                                        <p>It is a long established fact that a reader will be dis-tracted by the readable content of a page when look-ing at its layout...</p>
                                        <div class="more-link">
                                            <a href="blog-detail">Read More</a>
                                        </div>
                                    </div>
