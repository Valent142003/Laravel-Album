                            ...
                            <ul class="menu">
                                ...
                                <li class="active" >
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li class="active"><a href="blog-list-1">Blog list Slide 1</a></li>
    					...
    					<div class="post-wrap style1">
    						...
    						<article class="post clearfix">
    							<div class="title-post">
    								<h2><a href="blog-detail">The Design Museum Honours Azzedine Alaïa With A New Exhibition</a></h2>
    							</div><!-- /.title-post -->
    						...
    						<article class="post clearfix">
    							<div class="title-post">
    								<h2><a href="blog-detail">Looking For A New Statement Piece? Meet Bucherer Fine Jewellery</a></h2>
    							</div><!-- /.title-post -->
    							<div class="content-post">
    								<ul class="meta-post">
    									<li class="author padding-left-2">
