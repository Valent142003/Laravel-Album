                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li>
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li class="active"><a href="shop-detail-video">Details Video</a></li>                                
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
    				...
    				<div class="col-md-12">
    					...
    					<div class="breadcrumbs">
    						<ul>
                                ...
                                <li><a href="shop-detail-video">Products</a></li>
    						</ul>
    					</div><!-- /.breadcrumbs -->
    				</div><!-- /.col-md-12 -->
    			</div><!-- /.row -->
                                    ...
                                    <ul class="slides">
                                        <li data-thumb="images/shop/sh-detail/thumb-detail-12.jpg">
                                            ...
                                            <div class="flat-icon style-2">
                                                <a href="https://www.youtube.com/watch?v=LQpedLhpQsk" class="popup-video"><span class="fa fa-play"></span ><span class="text">Watch Video</span></a>
                                            </div>                                            
                                        </li>
